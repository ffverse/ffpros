...
ffpros will default to identifying itself to FantasyPros.com as `"ffpros R client package https://github.com/dynastyprocess/ffpros"`. If you would like to pass a different user agent, you can configure this with either of the following two methods:
